...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EqzZ0GB45Vgsr6bjlWy7.PSfR/sYxdbDnc8C0Pwa9vW.qEbfBG28XmDS29wtAMV3tyTYSqw/CN9Py5sLAJgpyBU=')
cl.loginResult()
...
╚═════════════════════════
"""
tjia="u16c87102beec3a162c9098c765519630"
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		gid = cl.getGroupIdsJoined()
                if msg.from_ in Creator:
		    for i in gid:
			cl.sendText(i,"ขออภัย! ฉันถูกบังคับโดยผู้ดูแลระบบ!!!")
		        cl.leaveGroup(i)
			ki.leaveGroup(i)
			kk.leaveGroup(i)
			kc.leaveGroup(i)
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                gs = cl.getGroup(msg.to)
                cl.sendText(msg.to,"ยินดีต้อนรับเข้าสู่ก���ุ่ม "+ gs.name)
                msg.contentType = 7
